...
exports.admin_list = (req, res) => {
    const { errors, isSuperAdminAuthenticated, user, userId } = req.session
    delete req.session.errors
    res.render("admin/admin_list",{errors, isSuperAdminAuthenticated, user, userId},(err, html) => {
        if (err) {
            console.log(err);
        }
        res.send(html)
...
exports.admin_profile = (req, res) => {
    const { errors, isSuperAdminAuthenticated, user, userId } = req.session
    delete req.session.errors
    res.render("admin/admin_profile",{errors, isSuperAdminAuthenticated, user, userId},(err, html) => {
        if (err) {
            console.log(err);
        }
        res.send(html)
...
exports.branches_list = (req, res) => {
    const { errors, isSuperAdminAuthenticated, user, userId } = req.session
    delete req.session.errors
    res.render("admin/branches_list",{errors, isSuperAdminAuthenticated, user, userId},(err, html) => {
        if (err) {
            console.log(err);
        }
        res.send(html)
...
exports.trainers_list = (req, res) => {
    const { errors, isSuperAdminAuthenticated, user, userId } = req.session
    delete req.session.errors
    res.render("admin/trainers_list",{errors, isSuperAdminAuthenticated, user, userId},(err, html) => {
        if (err) {
            console.log(err);
        }
        res.send(html)
...
exports.clients_list = (req, res) => {
    const { errors, isSuperAdminAuthenticated, user, userId } = req.session
    delete req.session.errors
    res.render("admin/clients_list",{errors, isSuperAdminAuthenticated, user, userId},(err, html) => {
        if (err) {
            console.log(err);
        }
        res.send(html)
